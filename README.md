...
Loqui is an easy tool for adding dialogs to your game in very simple way with help of documentation. System provides versality of features, but mainly:
...
## Project postponed
#### Why? 
Working on such a big project during school year made that work pretty hard, especially because after lessons solutions that I've implemented wasn't very clean and good. Code was looking more and more chaotic.
#### What I can do with this tool?
So you can basically create simple dialogs with this tool. Limitations are that you can't add more than 1 dialog tree to actor. Also there can be some issuses with changing graphics of buttons in dialog lines with choice. Also you can try to understand my spaghetti and continue with your own.
...
#### What will I do now?
This project gave me a lot of experience and I've learnt a lot about creating tools to unity which will help me in future. So the thing that I will for sure want to do is something that I always wanted to do - create my own game. Hopefully I'll be able to turn into something more for the first time.
...
## More about project
Project is open source on MIT license. Project has been created as just another step to fully understand Unity and is my hobby not job. 
![DialogExample](https://user-images.githubusercontent.com/20907620/183308771-fc7732bb-7f4b-46f7-8f69-f5bf49bc85a1.png)
*[photo outdated]*

Also to understand better and to make your first steps with this tool easier, there are [documentations](https://github.com/mmarusiak/LOQUI-unity-dialog-system/tree/main/docs) *postponed and outdated*.
